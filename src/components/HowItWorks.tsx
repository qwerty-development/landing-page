  ...
  const steps = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=800&q=80&fm=jpg&auto=format&fit=crop&grayscale",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800&q=80&fm=jpg&auto=format&fit=crop&grayscale",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1552566626-52f8b828add9?w=800&q=80&fm=jpg&auto=format&fit=crop&grayscale",
      features: [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1544025162-d76694265947?w=800&q=80&fm=jpg&auto=format&fit=crop&grayscale",
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* Interactive Steps */}
        <div
          className={`grid lg:grid-cols-2 gap-20 items-center mb-32 transition-all duration-1000 delay-300 ${
                  ...
                  >
                    ...
                    <div className="absolute bottom-12 left-12 right-12 text-white">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <span className="text-6xl font-thin opacity-50">
                          {step.number}
                        </span>
                      </div>
        ...
        >
          ...
          >
            <div className="text-center">
              ...
              <h3 className="text-4xl font-thin text-white mb-2">
                See Plate in Action
              </h3>

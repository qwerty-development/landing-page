...
import { ChevronLeft, ChevronRight, Heart, Zap, Shield, Award, Star, Diamond, Sparkles, Crown } from 'lucide-react';
...
const Benefits = () => {
  ...
  const experiences = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1559339352-11d035aa65de?w=1200&q=80&fm=jpg&auto=format&fit=crop&grayscale',
      icon: Heart,
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1550966871-3ed3cdb5ed0c?w=1200&q=80&fm=jpg&auto=format&fit=crop&grayscale',
      icon: Award,
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1537047902294-62a40c20a6ae?w=1200&q=80&fm=jpg&auto=format&fit=crop&grayscale',
      icon: Shield,
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?w=1200&q=80&fm=jpg&auto=format&fit=crop&grayscale',
      icon: Zap,
      accent: 'bg-gradient-to-br from-white/20 to-white/5'
    }
  ];
  ...
  const galleryImages = [
    { url: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&q=80&fm=jpg&auto=format&fit=crop&grayscale', title: 'Fine Dining', category: 'Luxury' },
    { url: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&q=80&fm=jpg&auto=format&fit=crop&grayscale', title: 'Culinary Art', category: 'Creative' },
    { url: 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=600&q=80&fm=jpg&auto=format&fit=crop&grayscale', title: 'Fresh Flavors', category: 'Organic' },
    { url: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=600&q=80&fm=jpg&auto=format&fit=crop&grayscale', title: 'Chef\'s Special', category: 'Signature' },
    { url: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80&fm=jpg&auto=format&fit=crop&grayscale', title: 'Local Cuisine', category: 'Traditional' },
    { url: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=600&q=80&fm=jpg&auto=format&fit=crop&grayscale', title: 'Sweet Endings', category: 'Dessert' }
  ];
    ...
    <section id="experience" ref={sectionRef} className="py-32 bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-24">
          <h2 className={`text-5xl md:text-7xl lg:text-8xl font-thin text-white mb-8 tracking-tight transition-all duration-1000 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            <span className="inline-block animate-fade-in-word" style={{ animationDelay: '0ms' }}>Every</span>{' '}
            <span className="inline-block animate-fade-in-word" style={{ animationDelay: '100ms' }}>occasion</span>
            <span className="block font-light italic text-gray-500 mt-2">
              <span className="inline-block animate-fade-in-word" style={{ animationDelay: '200ms' }}>deserves</span>{' '}
              <span className="inline-block animate-fade-in-word" style={{ animationDelay: '300ms' }}>perfection</span>
            </span>
          </h2>
          <p className={`text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-500 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            From spontaneous coffee meetings to grand celebrations, 
            we craft experiences that match your moment.
          </p>
        </div>

        {/* 3D Experience Carousel */}
        <div ref={carouselRef} className={`relative mb-32 transition-all duration-1000 delay-700 ${
              ...
              return (
                ...
                >
                  <div className="relative h-full rounded-3xl overflow-hidden group cursor-pointer"
                    ...
                    <div className={`absolute inset-0 ${exp.accent} opacity-30`}></div>
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end p-12">
                      <div className={`transition-all duration-700 ${
                        ...
                        <h3 className="text-6xl font-thin mb-3 text-white">{exp.title}</h3>
                        <p className="text-2xl text-white/80 font-light mb-2">{exp.subtitle}</p>
                        <p className="text-lg text-white/60">{exp.description}</p>
                      </div>
                    </div>
        ...
        {/* Interactive Gallery */}
        <div className={`mb-32 transition-all duration-1000 delay-900 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
              ...
              {galleryImages.map((image, index) => (
                ...
                >
                  <div className={`relative w-[400px] h-[500px] rounded-3xl overflow-hidden transition-all duration-700 ${
                    ...
                    {/* Overlay Content */}
                    <div className={`absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent flex flex-col justify-end p-8 transition-opacity duration-700 ${
                    ...
                    {/* Holographic Effect */}
                    <div className={`absolute inset-0 bg-gradient-to-br from-white/20 via-transparent to-white/20 opacity-0 ${
                      hoveredCard === index ? 'animate-holographic' : ''
                    }`}></div>
                  </div>
                </div>
              ))}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { icon: Zap, title: 'Lightning Fast', desc: 'Instant confirmations', color: 'from-white/20 to-white/5', delay: '0ms' },
            { icon: Crown, title: 'VIP Treatment', desc: 'Premium experiences', color: 'from-white/15 to-white/5', delay: '100ms' },
            { icon: Diamond, title: 'Hidden Gems', desc: 'Exclusive venues', color: 'from-white/25 to-white/5', delay: '200ms' },
            { icon: Sparkles, title: 'Magic Moments', desc: 'Unforgettable dining', color: 'from-white/20 to-white/5', delay: '300ms' }
          ].map((item, index) => (
            <div
              key={index}
            ...
            >
              <div className={`relative p-10 rounded-3xl border border-white/10 bg-gradient-to-br ${item.color} backdrop-blur-xl transition-all duration-700 ${
                hoveredCard === index + 100 ? 'transform rotateY(10deg) rotateX(-10deg) scale(1.05)' : ''
              }`}>
                {/* Icon Container */}
                ...
                <h4 className="text-2xl font-light text-white mb-3">{item.title}</h4>
      ...
      <style >{`
        ...
        @keyframes icon-particle {
          ...
          100% {
            transform: translate(calc(-50% + ${Math.random() * 60 - 30}px), calc(-50% + ${Math.random() * 60 - 30}px)) scale(1);
            opacity: 0;
          }
        }

...
const Features = () => {
  ...
  const gridFeatures = [
    { icon: MapPin, title: 'Location Intelligence', description: 'Find hidden gems nearby.', delay: '0ms' },
    { icon: Users, title: 'Group Booking', description: 'Coordinate any party size.', delay: '100ms' },
    { icon: Gift, title: 'Exclusive Access', description: 'Early access to new venues.', delay: '200ms' },
    { icon: MessageCircle, title: 'Social Dining', description: 'Share and discover.', delay: '300ms' }
  ];
    ...
    <section id="features" ref={sectionRef} className="py-32 bg-gray-950 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-24 relative">
          <h2 className={`text-5xl md:text-7xl lg:text-8xl font-thin text-white mb-6 tracking-tight transition-all duration-1000 ${
            isVisible ? 'opacity-100' : 'opacity-0'
          }`}>
            <span className="inline-block animate-slide-in-left">Designed for</span>
        ...
        <div className={`mb-32 transition-all duration-1000 delay-300 ${
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              {mainFeatures.map((feature, index) => (
                ...
                >
                  ...
                  <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000`}>
                    <div className={`absolute -inset-10 bg-gradient-to-br ${feature.gradient} blur-3xl animate-liquid`}></div>
                  </div>

                  <div className="relative flex items-start gap-6">
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 transition-all duration-700 relative overflow-hidden ${
                      activeFeature === index ? 'bg-white text-black' : 'bg-white/10 text-white'
                    }`}>
                      <feature.icon className="w-7 h-7 relative z-10" />
                      {/* Icon Glow */}
                      <div className={`absolute inset-0 bg-white blur-xl transition-opacity duration-700 ${
            ...
            <div className="relative h-[700px] overflow-hidden rounded-3xl" ref={cardsRef}>
              {mainFeatures.map((feature, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <div className="absolute inset-0 overflow-hidden">
                    {activeFeature === index && [...Array(20)].map((_, i) => (
                      <div
                        key={i}
                  ...
                  <div className="absolute bottom-8 left-8 right-8 text-white">
                    ...
                    <h3 className="text-4xl font-thin mb-2 tracking-wide">{feature.title}</h3>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className={`relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 to-gray-800 p-12 text-white group cursor-pointer transition-all duration-1000 ${
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-4xl font-thin mb-4 tracking-wide">Smart Notifications</h3>
              <p className="text-gray-400 leading-relaxed mb-6 text-lg">
                Get personalized alerts for new restaurant openings and exclusive events.
              </p>
          ...
          <div className={`relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-800 to-gray-900 p-12 text-white group cursor-pointer transition-all duration-1000 ${
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-4xl font-thin mb-4 tracking-wide">Plan Ahead</h3>
              <p className="text-gray-400 leading-relaxed mb-6 text-lg">
